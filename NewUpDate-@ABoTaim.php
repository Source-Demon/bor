...
*/
ob_start();
$token = '6219778435:AAEBROHoZo7_Ats-dW-iZ071AWV_oNLoPok';
...
$admin = 5992988366; // ايديك
$UserBot = "SSDTDSSBOT"; // معرف بوتك بدون @
$me = bot('getme',['bot'])->result->username;
$sales = json_decode(file_get_contents('sales.json'),1);
 $T4TTTT = 5992988366; //ايديك
...
'disable_web_page_preview'=>'true',
  ...
  $status = bot('getChatMember',['chat_id'=>'@haetmane5','user_id'=>$chat_id])->result->status;
  if($status == 'left'){
   bot('sendMessage',[
       'chat_id'=>$chat_id,
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"🔘 اضغط هنا للاشتراك",'url'=>'t.me/haetmane5']],
]])
   ]);
   exit();
  }
